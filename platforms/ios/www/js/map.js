...
window.sessionStorage.setItem('Latitude',"40.785211");
window.sessionStorage.setItem('Longitude',"-74.979634");
...
//    var longClick = plugin.google.maps.event.MAP_LONG_CLICK;
    var longClick = new google.maps.event.MAP_LONG_CLICK;
...
//            	if(window.localStorage.getItem('Latitude') != "" && window.localStorage.getItem('Latitude') != "null" && window.localStorage.getItem('Latitude') != null)
               if(window.sessionStorage.getItem('Latitude') != "" && window.sessionStorage.getItem('Latitude') != "null" && window.sessionStorage.getItem('Latitude') != null)
            	{
            	 var lat_lon1 = [];
//            	 lat_lon1[0] = new google.maps.LatLng(window.localStorage.getItem('Latitude'), window.localStorage.getItem('Longitude'));
                 lat_lon1[0] = new google.maps.LatLng(window.sessionStorage.getItem('Latitude'), window.sessionStorage.getItem('Longitude'));
